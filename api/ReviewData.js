...
const getReviewByUid = (uid) => new Promise((resolve, reject) => {
...
const getReviewByHairstyle = (hairstyleFirebaseKey) => new Promise((resolve, reject) => {
  fetch(`${endpoint}/reviews.json?orderBy="hairstyle_id"&equalTo="${hairstyleFirebaseKey}"`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
    },
...
export {
  getAllReviews, getReviewByUid, getSingleReview, createReview, updateReview, deleteReview, getReviewByHairstyle,
};
